module.exports = {
  ...
  findEventsInCity: (knex, cityName, cb) => {
    knex('cities')
      ...
      .select('users.username', 'events.title', 'events.description', 'events.image', 'events.keyword', 'events.start_date', 'events.end_date', 'events.start_time', 'events.end_time', 'events.location', 'cities.name', 'cities.id', 'events.id as eventId', 'users.id as userId')
